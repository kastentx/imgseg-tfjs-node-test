...
describe('test-tfjs node', function () {
    ...
    it('should be loaded', function (done) {
        var flow = [{ id: "n1", type: "test-tfjs", name: "test-tfjs" }];
        helper.load(node, flow, function () {
            var n1 = helper.getNode("n1");
            n1.should.have.property('name', 'test-tfjs');
            done();
        });
    });
    ...
    it('should have payload', function (done) {
        var flow = [
            { id: "n1", type: "test-tfjs", name: "test-tfjs", wires: [["n2"]] },
            { id: "n2", type: "helper" }
        ];
        helper.load(node, flow, function () {
